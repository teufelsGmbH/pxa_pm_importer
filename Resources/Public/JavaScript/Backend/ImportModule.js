define(['jquery'], function ($) {
	...
	let proto = ImportModule.prototype;
	 ...
	 */
	proto.submitButtonInit = function () {
	 ...
	 * @param importId
	 */
	proto.initProgressBar = function (importId) {
	 ...
	 * @return string
	 */
	proto.getjQueryInstance = function (element) {
